...
const Body = () => {
  ...
  },
  {
   ...
   return (
    ...
    <section className="overflow-hidden relative flex flex-col justify-center items-center relative h-[110dvh] bg-cover bg-center"
      style = {{
      backgroundImage: `url("/banner (2).png")`
      }}>
      
      <section className=' flex  mx-auto w-[80%] flex-col items-center gap-y-[10vh] justify-center'>
